...
package com.vivantecorp.graphics.tutorial2;
/*
...
//            GL2JNILib.init(width, height);
            ...
            if ( GL2JNILib.init(width, height)) {
                running = true;
                finished = false;
                Log.i("tutorial","init sucess!");
            }
            else {
                running = false;
                finished = true;
                Log.e("tutorial","init failed!");
            }
