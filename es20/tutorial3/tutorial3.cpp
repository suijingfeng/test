 ...
 */
static void create_x_window( Display *x_dpy, EGLDisplay egl_dpy,
              ...
              Window *winRet,  EGLContext *ctxRet, EGLSurface *surfRet )
{
...

    {
        ...
        win = XCreateWindow( x_dpy, root, x, y, w, h,
...
int main(int argc, char** argv)
{
    ...
    create_x_window(x_dpy, egl_dpy, "OpenGL ES 2.x glass ball", posX, posY, width, height,
    ...
    float fps = 1000000.0f * float(frameCount) / float(duration);
